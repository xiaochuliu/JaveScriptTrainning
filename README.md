...
Implement the following data structures and improvements. Use any instantiation style you like.
...
Write a function to return how many nodes your graph has. In order to accomplish this you will need to use node's fs module to read your adjacency list text file and split it into lines. Feel free to use the following code:
 ...
 11│
 12│
 13│// this line lets you access the file system
var fs = require('fs');
