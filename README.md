...
stackoverflow
<img src="https://cloud.githubusercontent.com/assets/6980359/12599698/132fd9f8-c449-11e5-8260-7a873a033747.png" alt="stackoverflow">twitter

The Twitter homepage might be composed of a <Feed> component containing many nested <Tweet> components:
<img src="https://cloud.githubusercontent.com/assets/6980359/12599699/14b02f8a-c449-11e5-850b-6dda90f210db.png" alt="twitter">A GitHub profile page might be composed of a <PopularRepos> component, and a <ContributedRepos> component, both containing nested <Repo> components, demonstrating component reuse:

github
<img src="https://cloud.githubusercontent.com/assets/6980359/12600063/8c787d90-c44b-11e5-8071-de75f091cd35.png" alt="github">Setup
...
To render a React component you use ReactDOM.render(componentInstance, DOMElement). JSX returns a component instance when you wrap a component in an HTML tag. Thus, to render the component App created above:
  ...
  1│ReactDOM.render(<App />, document.getElementById("actual-dom-element-where-I-want-to-render-my-component"));
...
Note that inside of JSX, you can write JavaScript expressions inside of curly braces:
 ...
 13│
 14│
 15│// Here we create a `TodoList` component
var TodoList = (props) => (
  <ul>
    <li>{props.todos[0]}</li>
    <li>{props.todos[1]}</li>
...
React makes this possible with class components. To demonstrate this, we'll refactor each <li> of our TodoList into a TodoListItem class component:
 ...
 33│
 34│
 35│// A class component can be defined as an ES6 class
...
state is only available on class components. We can initialize a class component's state in its constructor. To update the state, invoke this.setState. Whenever this.setState is called, the component re-renders.
 ...
 30│
 31│
 32│class TodoListItem extends React.Component {
  constructor(props) {
    super(props);
